    ...
    public class AlbumController : Controller
    {
        ...
        public async Task<IActionResult> Index(int ArtistSort=0, int GenreSort=0)
        {
            if (ArtistSort == 1 && GenreSort == 0)
                ...
                return View(_context.Albums.Include(a => a.Artist).Include(g => g.Genre.Name).OrderBy(g => g.Genre.Name).ToList());
            else if (ArtistSort == 2 && GenreSort == 0)
                return View(_context.Albums.Include(a => a.Artist).OrderByDescending(a => a.Artist).OrderBy(g => g.Genre).ToList());
            else if (ArtistSort == 0 && GenreSort == 2)
                return View(_context.Albums.Include(a => a.Artist).Include(g => g.Genre).OrderByDescending(g => g.Genre.Name).ToList());
            else
            {
